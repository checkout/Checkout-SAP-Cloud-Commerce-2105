 ...
 */
package com.checkout.hybris.sampledataaddon.jalo;

import com.checkout.hybris.sampledataaddon.constants.CheckoutsampledataaddonConstants;
...
/**
 * This is the extension manager of the Checkoutsampledataaddon extension.
 */
public class CheckoutsampledataaddonManager extends GeneratedCheckoutsampledataaddonManager {
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = Logger.getLogger(CheckoutsampledataaddonManager.class.getName());
     ...
     */
    public CheckoutsampledataaddonManager() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("constructor of CheckoutsampledataaddonManager called.");
        }
    }
     ...
     */
    public static CheckoutsampledataaddonManager getInstance() {
        return (CheckoutsampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
                CheckoutsampledataaddonConstants.EXTENSIONNAME);
    }
    ...
    public void init() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("init() of CheckoutsampledataaddonManager called. " + getTenant().getTenantID());
        }
    }
    ...
    public void destroy() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("destroy() of CheckoutsampledataaddonManager called, current tenant: " + getTenant().getTenantID());
        }
    }
