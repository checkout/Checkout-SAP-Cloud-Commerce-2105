...
<spring:url value="${placeOrderUrl}" var="checkoutComPlaceOrderUrl" htmlEscape="false"/>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
    ...
    <div class="row">
            ...
            <multi-checkout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
                <ycommerce:testId code="checkoutStepFour">
                    ...
                    <div class="place-order-form hidden-xs">
                        <form:form action="${checkoutComPlaceOrderUrl}" id="placeOrderForm1" modelAttribute="placeOrderForm">
                            <div class="checkbox">
        ...
        <div class="col-sm-6">
            <chko-multi-checkout:checkoutComOrderSummary cartData="${cartData}" showDeliveryAddress="true" showPaymentInfo="true" showTaxEstimate="true" showTax="true" />
        </div>
