                ...
                <div class="row">
                    <c:forEach items="${paymentInfoData}" var="paymentInfo">
                        <div class="col-xs-12 col-sm-6 col-md-4 card">
                            ...
                            <c:if test="${not isABC}">
                                <c:url value="/my-account/payment-details/edit/${paymentInfo.id}"
                                       var="editPaymentInstrumentUrl"/>
                                <a href="${editPaymentInstrumentUrl}" class="account-edit-address">
                                    <spring:theme code="text.edit"/>
                                </a>
                            </c:if>
                        </div>
                        ...
                        <div class="display-none">
                            <div id="popup_confirm_payment_removal_${fn:escapeXml(paymentInfo.id)}"
                                 class="account-address-removal-popup"><spring:theme
                                ...
                                <c:url value="/my-account/remove-payment-method-cko" var="removePaymentActionUrl"/>
                                <form:form id="removePaymentDetails${paymentInfo.id}" action="${removePaymentActionUrl}"
                                           method="post">
                                    <input type="hidden" name="paymentInfoId" value="${fn:escapeXml(paymentInfo.id)}"/>
                                    <br/>
