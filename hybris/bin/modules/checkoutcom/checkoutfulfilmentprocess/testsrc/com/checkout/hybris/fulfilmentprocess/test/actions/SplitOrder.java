 ...
 */
package com.checkout.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CheckoutfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CheckoutfulfilmentprocessConstants.PARENT_PROCESS);
