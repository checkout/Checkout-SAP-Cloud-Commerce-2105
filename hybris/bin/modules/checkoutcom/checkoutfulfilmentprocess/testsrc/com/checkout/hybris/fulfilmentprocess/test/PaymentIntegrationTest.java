...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		definitonFactory.add("classpath:/checkoutfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/checkoutfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/checkoutfulfilmentprocess/test/testCatalog.csv", "windows-1252");
