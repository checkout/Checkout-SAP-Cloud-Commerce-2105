package com.checkout.hybris.fulfilmentprocess.constants;

/**
 * Global class for all Checkoutfulfilmentprocess constants. You can add constants for your extension into this class.
 */
@SuppressWarnings({"unused", "cast", "deprecation", "squid:CallToDeprecatedMethod"})
public final class CheckoutfulfilmentprocessConstants extends GeneratedCheckoutfulfilmentprocessConstants {
    ...
    protected CheckoutfulfilmentprocessConstants() {
        //empty
    }
}